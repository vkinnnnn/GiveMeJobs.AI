...
from app.core.dependencies import (
    ...
    get_document_processing_dependencies,
    cleanup_all,
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    # Configure logging
    configure_logging()
    logger.info("Document Processing Service starting", version="1.0.0")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="GiveMeJobs Document Processing Service",
        description="AI-powered document processing and generation service",
        version="1.0.0",
    ...
    async def health_check(
        ...
        service_deps: ServiceDependencies = Depends(get_document_processing_dependencies)
    ):
